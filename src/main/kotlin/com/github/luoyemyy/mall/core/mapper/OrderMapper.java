...
public interface OrderMapper {
    ...
    @Insert({
        ...
        "#{signTime,jdbcType=TIMESTAMP}, #{wxPayId,jdbcType=VARCHAR}, ",
    ...
    @Select({
        ...
        "address, postcode, create_time, pay_time, deliver_time, sign_time, wx_pay_id, ",
        "wx_order_id, express_company, express_no, cancel_reason, refund_money, refuse_order_no, ",
        "refuse_wx_no, `status`",
        "from `order`",
        "where id = #{id,jdbcType=BIGINT}"
    })
