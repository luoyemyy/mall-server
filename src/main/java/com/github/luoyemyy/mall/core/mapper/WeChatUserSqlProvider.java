...
import com.github.luoyemyy.mall.core.entity.WeChatUserExample.Criteria;
import com.github.luoyemyy.mall.core.entity.WeChatUserExample.Criterion;
...
public class WeChatUserSqlProvider {
    ...
    public String selectByExample(WeChatUserExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        WeChatUser record = (WeChatUser) parameter.get("record");
    ...
    protected void applyWhere(WeChatUserExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
