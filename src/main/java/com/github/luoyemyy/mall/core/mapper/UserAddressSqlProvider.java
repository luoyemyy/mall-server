...
import com.github.luoyemyy.mall.core.entity.UserAddressExample.Criteria;
import com.github.luoyemyy.mall.core.entity.UserAddressExample.Criterion;
...
public class UserAddressSqlProvider {
    ...
    public String insertSelective(UserAddress record) {
        ...
        if (record.getAddressId() != null) {
            VALUES("address_id", "#{addressId,jdbcType=BIGINT}");
        }
    ...
    public String selectByExample(UserAddressExample example) {
        BEGIN();
