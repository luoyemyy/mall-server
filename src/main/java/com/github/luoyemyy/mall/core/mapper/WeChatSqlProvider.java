...
import com.github.luoyemyy.mall.core.entity.WeChatExample.Criteria;
import com.github.luoyemyy.mall.core.entity.WeChatExample.Criterion;
import com.github.luoyemyy.mall.core.entity.WeChatExample;
import java.util.List;
import java.util.Map;

public class WeChatSqlProvider {
    ...
    public String selectByExample(WeChatExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        WeChat record = (WeChat) parameter.get("record");
    ...
    protected void applyWhere(WeChatExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
