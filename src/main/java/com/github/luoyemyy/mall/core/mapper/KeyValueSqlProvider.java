...
import com.github.luoyemyy.mall.core.entity.KeyValueExample.Criteria;
import com.github.luoyemyy.mall.core.entity.KeyValueExample.Criterion;
import com.github.luoyemyy.mall.core.entity.KeyValueExample;
import java.util.List;
import java.util.Map;

public class KeyValueSqlProvider {
    ...
    public String insertSelective(KeyValue record) {
        ...
        if (record.getExpire() != null) {
            VALUES("expire", "#{expire,jdbcType=BIGINT}");
        }
        
        return SQL();
    }

    public String selectByExample(KeyValueExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        KeyValue record = (KeyValue) parameter.get("record");
    ...
    protected void applyWhere(KeyValueExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
