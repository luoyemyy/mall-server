...
CREATE TABLE `address` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='地址';
...
CREATE TABLE `order` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `order_no` varchar(45) DEFAULT NULL COMMENT '订单唯一id uuid 32位',
  `user_id` bigint(20) DEFAULT NULL,
  `state` int(11) DEFAULT NULL COMMENT '0 未支付 1 已支付，待确认 2 支付成功，待发货 3 运输中 4 已签收，交易完成 \n5 取消订单，待审核  6 退货，待审核 7 退货中 8 退款中 9 已取消',
  `money` float DEFAULT NULL COMMENT '总金额 包含邮费',
  `postage` float DEFAULT NULL COMMENT '邮费',
  `product_count` int(11) DEFAULT NULL,
  `username` varchar(45) DEFAULT NULL COMMENT '收件人姓名',
  `phone` varchar(45) DEFAULT NULL COMMENT '收件人电话',
  `address` varchar(255) DEFAULT NULL COMMENT '地址',
  `postcode` varchar(45) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `wx_pay_id` varchar(64) DEFAULT NULL COMMENT '微信支付统一下单号',
  `wx_order_id` varchar(45) DEFAULT NULL COMMENT '微信支付订单号',
  `express_company` varchar(45) DEFAULT NULL COMMENT '快递公司',
  `express_no` varchar(60) DEFAULT NULL COMMENT '快递单编号',
  `cancel_reason` varchar(100) DEFAULT NULL COMMENT '取消/退货原因',
  `refuse_order_no` varchar(45) DEFAULT NULL COMMENT '退款单号',
  `refuse_wx_no` varchar(45) DEFAULT NULL COMMENT '微信退款单号',
  `status` int(11) DEFAULT NULL COMMENT '0 已删除 1 有效',
  PRIMARY KEY (`id`)
...
CREATE TABLE `order_product` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8 COMMENT='订单产品';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shop_cart` (
  ...
  `count` int(11) DEFAULT NULL COMMENT '数量',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=203 DEFAULT CHARSET=utf8 COMMENT='购物车';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-04-24  9:05:52
