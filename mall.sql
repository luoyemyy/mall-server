...
CREATE TABLE IF NOT EXISTS `mall`.`user` (
  ...
  `head_image` VARCHAR(255) NULL COMMENT '头像id',
  `name` VARCHAR(45) CHARACTER SET 'DEFAULT' NULL COMMENT '昵称',
...
CREATE TABLE IF NOT EXISTS `mall`.`address` (
  ...
  `street` VARCHAR(60) NULL COMMENT '街道',
...
CREATE TABLE IF NOT EXISTS `mall`.`order` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `state` INT NULL COMMENT '0 未支付 1 已支付，待发货 2 运输中 3 已签收，交易完成 4 取消订单 5 退款中 6 已取消',
...
-- -----------------------------------------------------
-- Table `mall`.`we_chat_server`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mall`.`we_chat_server` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `access_token` VARCHAR(512) NULL,
  `access_token_expire` BIGINT(20) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
